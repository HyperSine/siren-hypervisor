...
namespace siren::x86 {
    ...
    constexpr uint32_t IA32_P5_MC_ADDR = 0x00000000;

    // See Section 2.23, "MSRs in Pentium Processors."
    constexpr uint32_t IA32_P5_MC_TYPE = 0x00000001;

    // See Section 8.10.5, "Monitor/Mwait Address Range Determination."
    constexpr uint32_t IA32_MONITOR_FILTER_SIZE = 0x00000006;

    // See Section 17.17, "Time-Stamp Counter."
    constexpr uint32_t IA32_TIME_STAMP_COUNTER = 0x00000010;
    ...
    constexpr uint32_t IA32_PLATFORM_ID = 0x00000017;
    ...
    constexpr uint32_t IA32_FEATURE_CONTROL = 0x0000003A;

    // Per Logical Processor TSC Adjust (R/Write to clear)
    constexpr uint32_t IA32_TSC_ADJUST = 0x0000003B;
    ...
    constexpr uint32_t IA32_PPIN_CTL = 0x0000004E;

    // Protected Processor Inventory Number (R/O)
    constexpr uint32_t IA32_PPIN = 0x0000004F;
    ...
    constexpr uint32_t IA32_BIOS_UPDT_TRIG = 0x00000079;
    ...
    constexpr uint32_t IA32_BIOS_SIGN_ID = 0x0000008B;
    ...
    constexpr uint32_t IA32_SGXLEPUBKEYHASH0 = 0x0000008C;
    ...
    constexpr uint32_t IA32_SGXLEPUBKEYHASH1 = 0x0000008D;
    ...
    constexpr uint32_t IA32_SGXLEPUBKEYHASH2 = 0x0000008E;
    ...
    constexpr uint32_t IA32_SGXLEPUBKEYHASH3 = 0x0000008F;

    // SMM Monitor Configuration (R/W)
    constexpr uint32_t IA32_SMM_MONITOR_CTL = 0x0000009B;

    // Base address of the logical processor's SMRAM image (R/O, SMM only).
    constexpr uint32_t IA32_SMBASE = 0x0000009E;

    // Power Filtering Control (R/W) This MSR has a value of 0 after reset and is unaffected by INIT# or SIPI#.
    constexpr uint32_t IA32_MISC_PACKAGE_CTLS = 0x000000BC;

    // General Performance Counter 0 (R/W)
    constexpr uint32_t IA32_PMC0 = 0x000000C1;

    // General Performance Counter 1 (R/W)
    constexpr uint32_t IA32_PMC1 = 0x000000C2;

    // General Performance Counter 2 (R/W)
    constexpr uint32_t IA32_PMC2 = 0x000000C3;

    // General Performance Counter 3 (R/W)
    constexpr uint32_t IA32_PMC3 = 0x000000C4;

    // General Performance Counter 4 (R/W)
    constexpr uint32_t IA32_PMC4 = 0x000000C5;

    // General Performance Counter 5 (R/W)
    constexpr uint32_t IA32_PMC5 = 0x000000C6;

    // General Performance Counter 6 (R/W)
    constexpr uint32_t IA32_PMC6 = 0x000000C7;

    // General Performance Counter 7 (R/W)
    constexpr uint32_t IA32_PMC7 = 0x000000C8;

    // IA32 Core Capabilities Register
    constexpr uint32_t IA32_CORE_CAPABILITIES = 0x000000CF;

    // UMWAIT Control (R/W)
    constexpr uint32_t IA32_UMWAIT_CONTROL = 0x000000E1;

    // TSC Frequency Clock Counter (R/Write to clear)
    constexpr uint32_t IA32_MPERF = 0x000000E7;
    ...
    constexpr uint32_t IA32_PERF_CTL = 0x00000199;

    // Clock Modulation Control (R/W) See Section 14.8.3, "Software Controlled Clock Modulation."
    constexpr uint32_t IA32_CLOCK_MODULATION = 0x0000019A;
    ...
    constexpr uint32_t IA32_THERM_INTERRUPT = 0x0000019B;
    ...
    constexpr uint32_t IA32_THERM_STATUS = 0x0000019C;

    // Enable Misc. Processor Features (R/W) Allows a variety of processor functions to be enabled and disabled.
    constexpr uint32_t IA32_MISC_ENABLE = 0x000001A0;

    // Performance Energy Bias Hint (R/W)
    constexpr uint32_t IA32_ENERGY_PERF_BIAS = 0x000001B0;
    ...
    constexpr uint32_t IA32_PACKAGE_THERM_STATUS = 0x000001B1;
    ...
    constexpr uint32_t IA32_PACKAGE_THERM_INTERRUPT = 0x000001B2;

    // Trace/Profile Resource Control (R/W)
    constexpr uint32_t IA32_DEBUGCTL = 0x000001D9;

    // Last Event Record Source IP Register (R/W)
    constexpr uint32_t IA32_LER_FROM_IP = 0x000001DD;

    // Last Event Record Destination IP Register (R/W)
    constexpr uint32_t IA32_LER_TO_IP = 0x000001DE;

    // Last Event Record Info Register (R/W)
    constexpr uint32_t IA32_LER_INFO = 0x000001E0;

    // SMRR Base Address (Writeable only in SMM) Base address of SMM memory range.
    constexpr uint32_t IA32_SMRR_PHYSBASE = 0x000001F2;

    // SMRR Range Mask (Writeable only in SMM) Range Mask of SMM memory range.
    constexpr uint32_t IA32_SMRR_PHYSMASK = 0x000001F3;

    // DCA Capability (R)
    constexpr uint32_t IA32_PLATFORM_DCA_CAP = 0x000001F8;

    // If set, CPU supports Prefetch-Hint type.
    constexpr uint32_t IA32_CPU_DCA_CAP = 0x000001F9;

    // DCA type 0 Status and Control register.
    constexpr uint32_t IA32_DCA_0_CAP = 0x000001FA;

    // See Section 11.11.2.3, "Variable Range MTRRs."
    constexpr uint32_t IA32_MTRR_PHYSBASE0 = 0x00000200;

    // MTRRphysMask0
    constexpr uint32_t IA32_MTRR_PHYSMASK0 = 0x00000201;

    // MTRRphysBase1
    constexpr uint32_t IA32_MTRR_PHYSBASE1 = 0x00000202;

    // MTRRphysMask1
    constexpr uint32_t IA32_MTRR_PHYSMASK1 = 0x00000203;

    // MTRRphysBase2
    constexpr uint32_t IA32_MTRR_PHYSBASE2 = 0x00000204;

    // MTRRphysMask2
    constexpr uint32_t IA32_MTRR_PHYSMASK2 = 0x00000205;

    // MTRRphysBase3
    constexpr uint32_t IA32_MTRR_PHYSBASE3 = 0x00000206;

    // MTRRphysMask3
    constexpr uint32_t IA32_MTRR_PHYSMASK3 = 0x00000207;

    // MTRRphysBase4
    constexpr uint32_t IA32_MTRR_PHYSBASE4 = 0x00000208;

    // MTRRphysMask4
    constexpr uint32_t IA32_MTRR_PHYSMASK4 = 0x00000209;

    // MTRRphysBase5
    constexpr uint32_t IA32_MTRR_PHYSBASE5 = 0x0000020A;

    // MTRRphysMask5
    constexpr uint32_t IA32_MTRR_PHYSMASK5 = 0x0000020B;

    // MTRRphysBase6
    constexpr uint32_t IA32_MTRR_PHYSBASE6 = 0x0000020C;

    // MTRRphysMask6
    constexpr uint32_t IA32_MTRR_PHYSMASK6 = 0x0000020D;

    // MTRRphysBase7
    constexpr uint32_t IA32_MTRR_PHYSBASE7 = 0x0000020E;

    // MTRRphysMask7
    constexpr uint32_t IA32_MTRR_PHYSMASK7 = 0x0000020F;

    // MTRRphysBase8
    constexpr uint32_t IA32_MTRR_PHYSBASE8 = 0x00000210;

    // MTRRphysMask8
    constexpr uint32_t IA32_MTRR_PHYSMASK8 = 0x00000211;

    // MTRRphysBase9
    constexpr uint32_t IA32_MTRR_PHYSBASE9 = 0x00000212;

    // MTRRphysMask9
    constexpr uint32_t IA32_MTRR_PHYSMASK9 = 0x00000213;

    // MTRRfix64K_00000
    constexpr uint32_t IA32_MTRR_FIX64K_00000 = 0x00000250;

    // MTRRfix16K_80000
    constexpr uint32_t IA32_MTRR_FIX16K_80000 = 0x00000258;

    // MTRRfix16K_A0000
    constexpr uint32_t IA32_MTRR_FIX16K_A0000 = 0x00000259;

    // See Section 11.11.2.2, "Fixed Range MTRRs."
    constexpr uint32_t IA32_MTRR_FIX4K_C0000 = 0x00000268;

    // MTRRfix4K_C8000
    constexpr uint32_t IA32_MTRR_FIX4K_C8000 = 0x00000269;

    // MTRRfix4K_D0000
    constexpr uint32_t IA32_MTRR_FIX4K_D0000 = 0x0000026A;

    // MTRRfix4K_D8000
    constexpr uint32_t IA32_MTRR_FIX4K_D8000 = 0x0000026B;

    // MTRRfix4K_E0000
    constexpr uint32_t IA32_MTRR_FIX4K_E0000 = 0x0000026C;

    // MTRRfix4K_E8000
    constexpr uint32_t IA32_MTRR_FIX4K_E8000 = 0x0000026D;

    // MTRRfix4K_F0000
    constexpr uint32_t IA32_MTRR_FIX4K_F0000 = 0x0000026E;

    // MTRRfix4K_F8000
    constexpr uint32_t IA32_MTRR_FIX4K_F8000 = 0x0000026F;
    ...
    constexpr uint32_t IA32_MC0_CTL2 = 0x00000280;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC1_CTL2 = 0x00000281;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC2_CTL2 = 0x00000282;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC3_CTL2 = 0x00000283;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC4_CTL2 = 0x00000284;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC5_CTL2 = 0x00000285;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC6_CTL2 = 0x00000286;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC7_CTL2 = 0x00000287;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC8_CTL2 = 0x00000288;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC9_CTL2 = 0x00000289;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC10_CTL2 = 0x0000028A;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC11_CTL2 = 0x0000028B;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC12_CTL2 = 0x0000028C;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC13_CTL2 = 0x0000028D;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC14_CTL2 = 0x0000028E;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC15_CTL2 = 0x0000028F;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC16_CTL2 = 0x00000290;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC17_CTL2 = 0x00000291;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC18_CTL2 = 0x00000292;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC19_CTL2 = 0x00000293;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC20_CTL2 = 0x00000294;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC21_CTL2 = 0x00000295;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC22_CTL2 = 0x00000296;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC23_CTL2 = 0x00000297;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC24_CTL2 = 0x00000298;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC25_CTL2 = 0x00000299;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC26_CTL2 = 0x0000029A;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC27_CTL2 = 0x0000029B;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC28_CTL2 = 0x0000029C;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC29_CTL2 = 0x0000029D;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC30_CTL2 = 0x0000029E;

    // (R/W) Same fields as IA32_MC0_CTL2.
    constexpr uint32_t IA32_MC31_CTL2 = 0x0000029F;

    // MTRRdefType (R/W)
    constexpr uint32_t IA32_MTRR_DEF_TYPE = 0x000002FF;

    // Fixed-Function Performance Counter 0 (R/W): Counts Instr_Retired.Any.
    constexpr uint32_t IA32_FIXED_CTR0 = 0x00000309;

    // Fixed-Function Performance Counter 1 (R/W): Counts CPU_CLK_Unhalted.Core.
    constexpr uint32_t IA32_FIXED_CTR1 = 0x0000030A;

    // Fixed-Function Performance Counter 2 (R/W): Counts CPU_CLK_Unhalted.Ref.
    constexpr uint32_t IA32_FIXED_CTR2 = 0x0000030B;

    // Read Only MSR that enumerates the existence of performance monitoring features. (R/O)
    constexpr uint32_t IA32_PERF_CAPABILITIES = 0x00000345;
    ...
    constexpr uint32_t IA32_FIXED_CTR_CTRL = 0x0000038D;

    // Performance Counter Status (R/O)
    constexpr uint32_t IA32_PERF_GLOBAL_STATUS = 0x0000038E;
    ...
    constexpr uint32_t IA32_PERF_GLOBAL_CTRL = 0x0000038F;

    // Global Performance Counter Overflow Control (R/W)
    constexpr uint32_t IA32_PERF_GLOBAL_OVF_CTRL = 0x00000390;

    // Global Performance Counter Overflow Reset Control (R/W)
    constexpr uint32_t IA32_PERF_GLOBAL_STATUS_RESET = 0x00000390;

    // Global Performance Counter Overflow Set Control (R/W)
    constexpr uint32_t IA32_PERF_GLOBAL_STATUS_SET = 0x00000391;

    // Indicator that core perfmon interface is in use. (R/O)
    constexpr uint32_t IA32_PERF_GLOBAL_INUSE = 0x00000392;

    // PEBS Control (R/W)
    constexpr uint32_t IA32_PEBS_ENABLE = 0x000003F1;

    // MC0_CTL
    constexpr uint32_t IA32_MC0_CTL = 0x00000400;

    // MC0_STATUS
    constexpr uint32_t IA32_MC0_STATUS = 0x00000401;

    // MC0_ADDR
    constexpr uint32_t IA32_MC0_ADDR = 0x00000402;

    // MC0_MISC
    constexpr uint32_t IA32_MC0_MISC = 0x00000403;

    // MC1_CTL
    constexpr uint32_t IA32_MC1_CTL = 0x00000404;

    // MC1_STATUS
    constexpr uint32_t IA32_MC1_STATUS = 0x00000405;

    // MC1_ADDR
    constexpr uint32_t IA32_MC1_ADDR = 0x00000406;

    // MC1_MISC
    constexpr uint32_t IA32_MC1_MISC = 0x00000407;

    // MC2_CTL
    constexpr uint32_t IA32_MC2_CTL = 0x00000408;

    // MC2_STATUS
    constexpr uint32_t IA32_MC2_STATUS = 0x00000409;

    // MC2_ADDR
    constexpr uint32_t IA32_MC2_ADDR = 0x0000040A;

    // MC2_MISC
    constexpr uint32_t IA32_MC2_MISC = 0x0000040B;

    // MC3_CTL
    constexpr uint32_t IA32_MC3_CTL = 0x0000040C;

    // MC3_STATUS
    constexpr uint32_t IA32_MC3_STATUS = 0x0000040D;

    // MC3_ADDR
    constexpr uint32_t IA32_MC3_ADDR = 0x0000040E;

    // MC3_MISC
    constexpr uint32_t IA32_MC3_MISC = 0x0000040F;

    // MC4_CTL
    constexpr uint32_t IA32_MC4_CTL = 0x00000410;

    // MC4_STATUS
    constexpr uint32_t IA32_MC4_STATUS = 0x00000411;

    // MC4_ADDR
    constexpr uint32_t IA32_MC4_ADDR = 0x00000412;

    // MC4_MISC
    constexpr uint32_t IA32_MC4_MISC = 0x00000413;

    // MC5_CTL
    constexpr uint32_t IA32_MC5_CTL = 0x00000414;

    // MC5_STATUS
    constexpr uint32_t IA32_MC5_STATUS = 0x00000415;

    // MC5_ADDR
    constexpr uint32_t IA32_MC5_ADDR = 0x00000416;

    // MC5_MISC
    constexpr uint32_t IA32_MC5_MISC = 0x00000417;

    // MC6_CTL
    constexpr uint32_t IA32_MC6_CTL = 0x00000418;

    // MC6_STATUS
    constexpr uint32_t IA32_MC6_STATUS = 0x00000419;

    // MC6_ADDR
    constexpr uint32_t IA32_MC6_ADDR = 0x0000041A;

    // MC6_MISC
    constexpr uint32_t IA32_MC6_MISC = 0x0000041B;

    // MC7_CTL
    constexpr uint32_t IA32_MC7_CTL = 0x0000041C;

    // MC7_STATUS
    constexpr uint32_t IA32_MC7_STATUS = 0x0000041D;

    // MC7_ADDR
    constexpr uint32_t IA32_MC7_ADDR = 0x0000041E;

    // MC7_MISC
    constexpr uint32_t IA32_MC7_MISC = 0x0000041F;

    // MC8_CTL
    constexpr uint32_t IA32_MC8_CTL = 0x00000420;

    // MC8_STATUS
    constexpr uint32_t IA32_MC8_STATUS = 0x00000421;

    // MC8_ADDR
    constexpr uint32_t IA32_MC8_ADDR = 0x00000422;

    // MC8_MISC
    constexpr uint32_t IA32_MC8_MISC = 0x00000423;

    // MC9_CTL
    constexpr uint32_t IA32_MC9_CTL = 0x00000424;

    // MC9_STATUS
    constexpr uint32_t IA32_MC9_STATUS = 0x00000425;

    // MC9_ADDR
    constexpr uint32_t IA32_MC9_ADDR = 0x00000426;

    // MC9_MISC
    constexpr uint32_t IA32_MC9_MISC = 0x00000427;

    // MC10_CTL
    constexpr uint32_t IA32_MC10_CTL = 0x00000428;

    // MC10_STATUS
    constexpr uint32_t IA32_MC10_STATUS = 0x00000429;

    // MC10_ADDR
    constexpr uint32_t IA32_MC10_ADDR = 0x0000042A;

    // MC10_MISC
    constexpr uint32_t IA32_MC10_MISC = 0x0000042B;

    // MC11_CTL
    constexpr uint32_t IA32_MC11_CTL = 0x0000042C;

    // MC11_STATUS
    constexpr uint32_t IA32_MC11_STATUS = 0x0000042D;

    // MC11_ADDR
    constexpr uint32_t IA32_MC11_ADDR = 0x0000042E;

    // MC11_MISC
    constexpr uint32_t IA32_MC11_MISC = 0x0000042F;

    // MC12_CTL
    constexpr uint32_t IA32_MC12_CTL = 0x00000430;

    // MC12_STATUS
    constexpr uint32_t IA32_MC12_STATUS = 0x00000431;

    // MC12_ADDR
    constexpr uint32_t IA32_MC12_ADDR = 0x00000432;

    // MC12_MISC
    constexpr uint32_t IA32_MC12_MISC = 0x00000433;

    // MC13_CTL
    constexpr uint32_t IA32_MC13_CTL = 0x00000434;

    // MC13_STATUS
    constexpr uint32_t IA32_MC13_STATUS = 0x00000435;

    // MC13_ADDR
    constexpr uint32_t IA32_MC13_ADDR = 0x00000436;

    // MC13_MISC
    constexpr uint32_t IA32_MC13_MISC = 0x00000437;

    // MC14_CTL
    constexpr uint32_t IA32_MC14_CTL = 0x00000438;

    // MC14_STATUS
    constexpr uint32_t IA32_MC14_STATUS = 0x00000439;

    // MC14_ADDR
    constexpr uint32_t IA32_MC14_ADDR = 0x0000043A;

    // MC14_MISC
    constexpr uint32_t IA32_MC14_MISC = 0x0000043B;

    // MC15_CTL
    constexpr uint32_t IA32_MC15_CTL = 0x0000043C;

    // MC15_STATUS
    constexpr uint32_t IA32_MC15_STATUS = 0x0000043D;

    // MC15_ADDR
    constexpr uint32_t IA32_MC15_ADDR = 0x0000043E;

    // MC15_MISC
    constexpr uint32_t IA32_MC15_MISC = 0x0000043F;

    // MC16_CTL
    constexpr uint32_t IA32_MC16_CTL = 0x00000440;

    // MC16_STATUS
    constexpr uint32_t IA32_MC16_STATUS = 0x00000441;

    // MC16_ADDR
    constexpr uint32_t IA32_MC16_ADDR = 0x00000442;

    // MC16_MISC
    constexpr uint32_t IA32_MC16_MISC = 0x00000443;

    // MC17_CTL
    constexpr uint32_t IA32_MC17_CTL = 0x00000444;

    // MC17_STATUS
    constexpr uint32_t IA32_MC17_STATUS = 0x00000445;

    // MC17_ADDR
    constexpr uint32_t IA32_MC17_ADDR = 0x00000446;

    // MC17_MISC
    constexpr uint32_t IA32_MC17_MISC = 0x00000447;

    // MC18_CTL
    constexpr uint32_t IA32_MC18_CTL = 0x00000448;

    // MC18_STATUS
    constexpr uint32_t IA32_MC18_STATUS = 0x00000449;

    // MC18_ADDR
    constexpr uint32_t IA32_MC18_ADDR = 0x0000044A;

    // MC18_MISC
    constexpr uint32_t IA32_MC18_MISC = 0x0000044B;

    // MC19_CTL
    constexpr uint32_t IA32_MC19_CTL = 0x0000044C;

    // MC19_STATUS
    constexpr uint32_t IA32_MC19_STATUS = 0x0000044D;

    // MC19_ADDR
    constexpr uint32_t IA32_MC19_ADDR = 0x0000044E;

    // MC19_MISC
    constexpr uint32_t IA32_MC19_MISC = 0x0000044F;

    // MC20_CTL
    constexpr uint32_t IA32_MC20_CTL = 0x00000450;

    // MC20_STATUS
    constexpr uint32_t IA32_MC20_STATUS = 0x00000451;

    // MC20_ADDR
    constexpr uint32_t IA32_MC20_ADDR = 0x00000452;

    // MC20_MISC
    constexpr uint32_t IA32_MC20_MISC = 0x00000453;

    // MC21_CTL
    constexpr uint32_t IA32_MC21_CTL = 0x00000454;

    // MC21_STATUS
    constexpr uint32_t IA32_MC21_STATUS = 0x00000455;

    // MC21_ADDR
    constexpr uint32_t IA32_MC21_ADDR = 0x00000456;

    // MC21_MISC
    constexpr uint32_t IA32_MC21_MISC = 0x00000457;

    // MC22_CTL
    constexpr uint32_t IA32_MC22_CTL = 0x00000458;

    // MC22_STATUS
    constexpr uint32_t IA32_MC22_STATUS = 0x00000459;

    // MC22_ADDR
    constexpr uint32_t IA32_MC22_ADDR = 0x0000045A;

    // MC22_MISC
    constexpr uint32_t IA32_MC22_MISC = 0x0000045B;

    // MC23_CTL
    constexpr uint32_t IA32_MC23_CTL = 0x0000045C;

    // MC23_STATUS
    constexpr uint32_t IA32_MC23_STATUS = 0x0000045D;

    // MC23_ADDR
    constexpr uint32_t IA32_MC23_ADDR = 0x0000045E;

    // MC23_MISC
    constexpr uint32_t IA32_MC23_MISC = 0x0000045F;

    // MC24_CTL
    constexpr uint32_t IA32_MC24_CTL = 0x00000460;

    // MC24_STATUS
    constexpr uint32_t IA32_MC24_STATUS = 0x00000461;

    // MC24_ADDR
    constexpr uint32_t IA32_MC24_ADDR = 0x00000462;

    // MC24_MISC
    constexpr uint32_t IA32_MC24_MISC = 0x00000463;

    // MC25_CTL
    constexpr uint32_t IA32_MC25_CTL = 0x00000464;

    // MC25_STATUS
    constexpr uint32_t IA32_MC25_STATUS = 0x00000465;

    // MC25_ADDR
    constexpr uint32_t IA32_MC25_ADDR = 0x00000466;

    // MC25_MISC
    constexpr uint32_t IA32_MC25_MISC = 0x00000467;

    // MC26_CTL
    constexpr uint32_t IA32_MC26_CTL = 0x00000468;

    // MC26_STATUS
    constexpr uint32_t IA32_MC26_STATUS = 0x00000469;

    // MC26_ADDR
    constexpr uint32_t IA32_MC26_ADDR = 0x0000046A;

    // MC26_MISC
    constexpr uint32_t IA32_MC26_MISC = 0x0000046B;

    // MC27_CTL
    constexpr uint32_t IA32_MC27_CTL = 0x0000046C;

    // MC27_STATUS
    constexpr uint32_t IA32_MC27_STATUS = 0x0000046D;

    // MC27_ADDR
    constexpr uint32_t IA32_MC27_ADDR = 0x0000046E;

    // MC27_MISC
    constexpr uint32_t IA32_MC27_MISC = 0x0000046F;

    // MC28_CTL
    constexpr uint32_t IA32_MC28_CTL = 0x00000470;

    // MC28_STATUS
    constexpr uint32_t IA32_MC28_STATUS = 0x00000471;

    // MC28_ADDR
    constexpr uint32_t IA32_MC28_ADDR = 0x00000472;

    // MC28_MISC
    constexpr uint32_t IA32_MC28_MISC = 0x00000473;

    // Reporting Register of Basic VMX Capabilities (R/O) See Appendix A.1, "Basic VMX Information."
    constexpr uint32_t IA32_VMX_BASIC = 0x00000480;

    // Capability Reporting Register of Pin-Based VM-Execution Controls (R/O) See Appendix A.3.1, "Pin-Based VM- Execution Controls."
    constexpr uint32_t IA32_VMX_PINBASED_CTLS = 0x00000481;
    ...
    constexpr uint32_t IA32_VMX_PROCBASED_CTLS2 = 0x0000048B;

    // Capability Reporting Register of EPT and VPID (R/O) See Appendix A.10, "VPID and EPT Capabilities."
    constexpr uint32_t IA32_VMX_EPT_VPID_CAP = 0x0000048C;
    ...
    constexpr uint32_t IA32_VMX_TRUE_PINBASED_CTLS = 0x0000048D;
    ...
    constexpr uint32_t IA32_VMX_PROCBASED_CTLS3 = 0x00000492;

    // Capability Reporting Register of Secondary VM-Exit Controls (R/O) See Appendix A.4.2, "Secondary VM-Exit Controls."
    constexpr uint32_t IA32_VMX_EXIT_CTLS2 = 0x00000493;

    // Full Width Writable IA32_PMC0 Alias (R/W)
    constexpr uint32_t IA32_A_PMC0 = 0x000004C1;

    // Full Width Writable IA32_PMC1 Alias (R/W)
    constexpr uint32_t IA32_A_PMC1 = 0x000004C2;

    // Full Width Writable IA32_PMC2 Alias (R/W)
    constexpr uint32_t IA32_A_PMC2 = 0x000004C3;

    // Full Width Writable IA32_PMC3 Alias (R/W)
    constexpr uint32_t IA32_A_PMC3 = 0x000004C4;

    // Full Width Writable IA32_PMC4 Alias (R/W)
    constexpr uint32_t IA32_A_PMC4 = 0x000004C5;

    // Full Width Writable IA32_PMC5 Alias (R/W)
    constexpr uint32_t IA32_A_PMC5 = 0x000004C6;

    // Full Width Writable IA32_PMC6 Alias (R/W)
    constexpr uint32_t IA32_A_PMC6 = 0x000004C7;

    // Full Width Writable IA32_PMC7 Alias (R/W)
    constexpr uint32_t IA32_A_PMC7 = 0x000004C8;
    ...
    constexpr uint32_t IA32_MCG_EXT_CTL = 0x000004D0;

    // Status and SVN Threshold of SGX Support for ACM (R/O).
    constexpr uint32_t IA32_SGX_SVN_STATUS = 0x00000500;

    // Trace Output Base Register (R/W)
    constexpr uint32_t IA32_RTIT_OUTPUT_BASE = 0x00000560;

    // Trace Output Mask Pointers Register (R/W) If ((CPUID.(EAX=07H,
    constexpr uint32_t IA32_RTIT_OUTPUT_MASK_PTRS = 0x00000561;

    // Trace Control Register (R/W)
    constexpr uint32_t IA32_RTIT_CTL = 0x00000570;

    // Tracing Status Register (R/W)
    constexpr uint32_t IA32_RTIT_STATUS = 0x00000571;

    // Trace Filter CR3 Match Register (R/W)
    constexpr uint32_t IA32_RTIT_CR3_MATCH = 0x00000572;

    // Region 0 Start Address (R/W)
    constexpr uint32_t IA32_RTIT_ADDR0_A = 0x00000580;

    // Region 0 End Address (R/W)
    constexpr uint32_t IA32_RTIT_ADDR0_B = 0x00000581;

    // Region 1 Start Address (R/W)
    constexpr uint32_t IA32_RTIT_ADDR1_A = 0x00000582;

    // Region 1 End Address (R/W)
    constexpr uint32_t IA32_RTIT_ADDR1_B = 0x00000583;

    // Region 2 Start Address (R/W)
    constexpr uint32_t IA32_RTIT_ADDR2_A = 0x00000584;

    // Region 2 End Address (R/W)
    constexpr uint32_t IA32_RTIT_ADDR2_B = 0x00000585;

    // Region 3 Start Address (R/W)
    constexpr uint32_t IA32_RTIT_ADDR3_A = 0x00000586;

    // Region 3 End Address (R/W)
    constexpr uint32_t IA32_RTIT_ADDR3_B = 0x00000587;
    ...
    constexpr uint32_t IA32_DS_AREA = 0x00000600;

    // Configure User Mode CET (R/W)
    constexpr uint32_t IA32_U_CET = 0x000006A0;

    // Configure Supervisor Mode CET (R/W)
    constexpr uint32_t IA32_S_CET = 0x000006A2;
    ...
    constexpr uint32_t IA32_INTERRUPT_SSP_TABLE_ADDR = 0x000006A8;

    // TSC Target of Local APIC's TSC Deadline Mode (R/W)
    constexpr uint32_t IA32_TSC_DEADLINE = 0x000006E0;

    // Specifies the PK permissions associated with each protection domain for supervisor pages (R/W)
    constexpr uint32_t IA32_PKRS = 0x000006E1;

    // Enable/disable HWP (R/W)
    constexpr uint32_t IA32_PM_ENABLE = 0x00000770;

    // HWP Performance Range Enumeration (R/O)
    constexpr uint32_t IA32_HWP_CAPABILITIES = 0x00000771;

    // Power Management Control Hints for All Logical Processors in a Package (R/W)
    constexpr uint32_t IA32_HWP_REQUEST_PKG = 0x00000772;

    // Control HWP Native Interrupts (R/W)
    constexpr uint32_t IA32_HWP_INTERRUPT = 0x00000773;

    // Power Management Control Hints to a Logical Processor (R/W)
    constexpr uint32_t IA32_HWP_REQUEST = 0x00000774;

    // IA32_PECI_HWP_REQUEST_INFO
    constexpr uint32_t IA32_PECI_HWP_REQUEST_INFO = 0x00000775;

    // IA32_HWP_CTL
    constexpr uint32_t IA32_HWP_CTL = 0x00000776;

    // Log bits indicating changes to Guaranteed & excursions to Minimum (R/W)
    constexpr uint32_t IA32_HWP_STATUS = 0x00000777;

    // x2APIC ID Register (R/O) See x2APIC Specification.
    constexpr uint32_t IA32_X2APIC_APICID = 0x00000802;

    // x2APIC Version Register (R/O)
    constexpr uint32_t IA32_X2APIC_VERSION = 0x00000803;

    // x2APIC Task Priority Register (R/W)
    constexpr uint32_t IA32_X2APIC_TPR = 0x00000808;

    // x2APIC Processor Priority Register (R/O)
    constexpr uint32_t IA32_X2APIC_PPR = 0x0000080A;

    // x2APIC EOI Register (W/O)
    constexpr uint32_t IA32_X2APIC_EOI = 0x0000080B;

    // x2APIC Logical Destination Register (R/O)
    constexpr uint32_t IA32_X2APIC_LDR = 0x0000080D;

    // x2APIC Spurious Interrupt Vector Register (R/W)
    constexpr uint32_t IA32_X2APIC_SIVR = 0x0000080F;

    // x2APIC In-Service Register Bits 31:0 (R/O)
    constexpr uint32_t IA32_X2APIC_ISR0 = 0x00000810;

    // x2APIC In-Service Register Bits 63:32 (R/O) If CPUID.01H:ECX.[21] = 1
    constexpr uint32_t IA32_X2APIC_ISR1 = 0x00000811;

    // x2APIC In-Service Register Bits 95:64 (R/O) If CPUID.01H:ECX.[21] = 1
    constexpr uint32_t IA32_X2APIC_ISR2 = 0x00000812;

    // x2APIC In-Service Register Bits 127:96 (R/O)
    constexpr uint32_t IA32_X2APIC_ISR3 = 0x00000813;

    // x2APIC In-Service Register Bits 159:128 (R/O)
    constexpr uint32_t IA32_X2APIC_ISR4 = 0x00000814;

    // x2APIC In-Service Register Bits 191:160 (R/O)
    constexpr uint32_t IA32_X2APIC_ISR5 = 0x00000815;

    // x2APIC In-Service Register Bits 223:192 (R/O)
    constexpr uint32_t IA32_X2APIC_ISR6 = 0x00000816;

    // x2APIC In-Service Register Bits 255:224 (R/O)
    constexpr uint32_t IA32_X2APIC_ISR7 = 0x00000817;

    // x2APIC Trigger Mode Register Bits 31:0 (R/O)
    constexpr uint32_t IA32_X2APIC_TMR0 = 0x00000818;

    // x2APIC Trigger Mode Register Bits 63:32 (R/O)
    constexpr uint32_t IA32_X2APIC_TMR1 = 0x00000819;

    // x2APIC Trigger Mode Register Bits 95:64 (R/O)
    constexpr uint32_t IA32_X2APIC_TMR2 = 0x0000081A;

    // x2APIC Trigger Mode Register Bits 127:96 (R/O)
    constexpr uint32_t IA32_X2APIC_TMR3 = 0x0000081B;

    // x2APIC Trigger Mode Register Bits 159:128 (R/O)
    constexpr uint32_t IA32_X2APIC_TMR4 = 0x0000081C;

    // x2APIC Trigger Mode Register Bits 191:160 (R/O)
    constexpr uint32_t IA32_X2APIC_TMR5 = 0x0000081D;

    // x2APIC Trigger Mode Register Bits 223:192 (R/O)
    constexpr uint32_t IA32_X2APIC_TMR6 = 0x0000081E;

    // x2APIC Trigger Mode Register Bits 255:224 (R/O)
    constexpr uint32_t IA32_X2APIC_TMR7 = 0x0000081F;

    // x2APIC Interrupt Request Register Bits 31:0 (R/O)
    constexpr uint32_t IA32_X2APIC_IRR0 = 0x00000820;

    // x2APIC Interrupt Request Register Bits 63:32 (R/O)
    constexpr uint32_t IA32_X2APIC_IRR1 = 0x00000821;

    // x2APIC Interrupt Request Register Bits 95:64 (R/O)
    constexpr uint32_t IA32_X2APIC_IRR2 = 0x00000822;

    // x2APIC Interrupt Request Register Bits 127:96 (R/O)
    constexpr uint32_t IA32_X2APIC_IRR3 = 0x00000823;

    // x2APIC Interrupt Request Register Bits 159:128 (R/O)
    constexpr uint32_t IA32_X2APIC_IRR4 = 0x00000824;

    // x2APIC Interrupt Request Register Bits 191:160 (R/O)
    constexpr uint32_t IA32_X2APIC_IRR5 = 0x00000825;

    // x2APIC Interrupt Request Register Bits 223:192 (R/O)
    constexpr uint32_t IA32_X2APIC_IRR6 = 0x00000826;

    // x2APIC Interrupt Request Register Bits 255:224 (R/O)
    constexpr uint32_t IA32_X2APIC_IRR7 = 0x00000827;

    // x2APIC Error Status Register (R/W)
    constexpr uint32_t IA32_X2APIC_ESR = 0x00000828;

    // x2APIC LVT Corrected Machine Check Interrupt Register (R/W)
    constexpr uint32_t IA32_X2APIC_LVT_CMCI = 0x0000082F;

    // x2APIC Interrupt Command Register (R/W)
    constexpr uint32_t IA32_X2APIC_ICR = 0x00000830;

    // x2APIC LVT Timer Interrupt Register (R/W) If CPUID.01H:ECX.[21] = 1
    constexpr uint32_t IA32_X2APIC_LVT_TIMER = 0x00000832;

    // x2APIC LVT Thermal Sensor Interrupt Register (R/W)
    constexpr uint32_t IA32_X2APIC_LVT_THERMAL = 0x00000833;

    // x2APIC LVT Performance Monitor Interrupt Register (R/W)
    constexpr uint32_t IA32_X2APIC_LVT_PMI = 0x00000834;

    // x2APIC LVT LINT0 Register (R/W)
    constexpr uint32_t IA32_X2APIC_LVT_LINT0 = 0x00000835;

    // x2APIC LVT LINT1 Register (R/W)
    constexpr uint32_t IA32_X2APIC_LVT_LINT1 = 0x00000836;

    // x2APIC LVT Error Register (R/W)
    constexpr uint32_t IA32_X2APIC_LVT_ERROR = 0x00000837;

    // x2APIC Initial Count Register (R/W)
    constexpr uint32_t IA32_X2APIC_INIT_COUNT = 0x00000838;

    // x2APIC Current Count Register (R/O)
    constexpr uint32_t IA32_X2APIC_CUR_COUNT = 0x00000839;

    // x2APIC Divide Configuration Register (R/W) If CPUID.01H:ECX.[21] = 1
    constexpr uint32_t IA32_X2APIC_DIV_CONF = 0x0000083E;

    // x2APIC Self IPI Register (W/O)
    constexpr uint32_t IA32_X2APIC_SELF_IPI = 0x0000083F;

    // Memory Encryption Capability MSR
    constexpr uint32_t IA32_TME_CAPABILITY = 0x00000981;
    ...
    constexpr uint32_t IA32_TME_ACTIVATE = 0x00000982;

    // Memory Encryption Exclude Mask
    constexpr uint32_t IA32_TME_EXCLUDE_MASK = 0x00000983;

    // Memory Encryption Exclude Base
    constexpr uint32_t IA32_TME_EXCLUDE_BASE = 0x00000984;

    // Status of Most Recent Platform to Local or Local to Platform Copies (R/O)
    constexpr uint32_t IA32_COPY_STATUS = 0x00000990;

    // Information about IWKeyBackup Register (R/O)
    constexpr uint32_t IA32_IWKEYBACKUP_STATUS = 0x00000991;

    // Silicon Debug Feature Control (R/W)
    constexpr uint32_t IA32_DEBUG_INTERFACE = 0x00000C80;

    // L3 QOS Configuration (R/W)
    constexpr uint32_t IA32_L3_QOS_CFG = 0x00000C81;

    // L2 QOS Configuration (R/W)
    constexpr uint32_t IA32_L2_QOS_CFG = 0x00000C82;

    // Monitoring Event Select Register (R/W)
    constexpr uint32_t IA32_QM_EVTSEL = 0x00000C8D;

    // Monitoring Counter Register (R/O)
    constexpr uint32_t IA32_QM_CTR = 0x00000C8E;

    // Resource Association Register (R/W)
    constexpr uint32_t IA32_PQR_ASSOC = 0x00000C8F;

    // L3 CAT Mask for COS0 (R/W)
    constexpr uint32_t IA32_L3_MASK_0 = 0x00000C90;

    // L2 CAT Mask for COS0 (R/W)
    constexpr uint32_t IA32_L2_MASK_0 = 0x00000D10;

    // Supervisor State of MPX Configuration (R/W)
    constexpr uint32_t IA32_BNDCFGS = 0x00000D90;

    // Copy Local State to Platform State (W)
    constexpr uint32_t IA32_COPY_LOCAL_TO_PLATFORM = 0x00000D91;

    // Copy Platform State to Local State (W)
    constexpr uint32_t IA32_COPY_PLATFORM_TO_LOCAL = 0x00000D92;

    // Extended Supervisor State Mask (R/W)
    constexpr uint32_t IA32_XSS = 0x00000DA0;

    // Package Level Enable/disable HDC (R/W)
    constexpr uint32_t IA32_PKG_HDC_CTL = 0x00000DB0;

    // Enable/disable HWP (R/W)
    constexpr uint32_t IA32_PM_CTL1 = 0x00000DB1;

    // Per-Logical_Processor HDC Idle Residency (R/0)
    constexpr uint32_t IA32_THREAD_STALL = 0x00000DB2;
    ...
    constexpr uint32_t IA32_LBR_1200_INFO = 0x00001200;
    ...
    constexpr uint32_t IA32_LBR_1201_INFO = 0x00001201;
    ...
    constexpr uint32_t IA32_LBR_1202_INFO = 0x00001202;
    ...
    constexpr uint32_t IA32_LBR_1203_INFO = 0x00001203;
    ...
    constexpr uint32_t IA32_LBR_1204_INFO = 0x00001204;
    ...
    constexpr uint32_t IA32_LBR_1205_INFO = 0x00001205;
    ...
    constexpr uint32_t IA32_LBR_1206_INFO = 0x00001206;
    ...
    constexpr uint32_t IA32_LBR_1207_INFO = 0x00001207;
    ...
    constexpr uint32_t IA32_LBR_1208_INFO = 0x00001208;
    ...
    constexpr uint32_t IA32_LBR_1209_INFO = 0x00001209;
    ...
    constexpr uint32_t IA32_LBR_120A_INFO = 0x0000120A;
    ...
    constexpr uint32_t IA32_LBR_120B_INFO = 0x0000120B;
    ...
    constexpr uint32_t IA32_LBR_120C_INFO = 0x0000120C;
    ...
    constexpr uint32_t IA32_LBR_120D_INFO = 0x0000120D;
    ...
    constexpr uint32_t IA32_LBR_120E_INFO = 0x0000120E;
    ...
    constexpr uint32_t IA32_LBR_120F_INFO = 0x0000120F;
    ...
    constexpr uint32_t IA32_LBR_1210_INFO = 0x00001210;
    ...
    constexpr uint32_t IA32_LBR_1211_INFO = 0x00001211;
    ...
    constexpr uint32_t IA32_LBR_1212_INFO = 0x00001212;
    ...
    constexpr uint32_t IA32_LBR_1213_INFO = 0x00001213;
    ...
    constexpr uint32_t IA32_LBR_1214_INFO = 0x00001214;
    ...
    constexpr uint32_t IA32_LBR_1215_INFO = 0x00001215;
    ...
    constexpr uint32_t IA32_LBR_1216_INFO = 0x00001216;
    ...
    constexpr uint32_t IA32_LBR_1217_INFO = 0x00001217;
    ...
    constexpr uint32_t IA32_LBR_1218_INFO = 0x00001218;
    ...
    constexpr uint32_t IA32_LBR_1219_INFO = 0x00001219;
    ...
    constexpr uint32_t IA32_LBR_121A_INFO = 0x0000121A;
    ...
    constexpr uint32_t IA32_LBR_121B_INFO = 0x0000121B;
    ...
    constexpr uint32_t IA32_LBR_121C_INFO = 0x0000121C;
    ...
    constexpr uint32_t IA32_LBR_121D_INFO = 0x0000121D;
    ...
    constexpr uint32_t IA32_LBR_121E_INFO = 0x0000121E;
    ...
    constexpr uint32_t IA32_LBR_121F_INFO = 0x0000121F;

    // Last Branch Record Enabling and Configuration Register (R/W)
    constexpr uint32_t IA32_LBR_CTL = 0x000014CE;

    // Last Branch Record Maximum Stack Depth Register (R/W)
    constexpr uint32_t IA32_LBR_DEPTH = 0x000014CF;
    ...
    constexpr uint32_t IA32_LBR_1500_FROM_IP = 0x00001500;
    ...
    constexpr uint32_t IA32_LBR_1501_FROM_IP = 0x00001501;
    ...
    constexpr uint32_t IA32_LBR_1502_FROM_IP = 0x00001502;
    ...
    constexpr uint32_t IA32_LBR_1503_FROM_IP = 0x00001503;
    ...
    constexpr uint32_t IA32_LBR_1504_FROM_IP = 0x00001504;
    ...
    constexpr uint32_t IA32_LBR_1505_FROM_IP = 0x00001505;
    ...
    constexpr uint32_t IA32_LBR_1506_FROM_IP = 0x00001506;
    ...
    constexpr uint32_t IA32_LBR_1507_FROM_IP = 0x00001507;
    ...
    constexpr uint32_t IA32_LBR_1508_FROM_IP = 0x00001508;
    ...
    constexpr uint32_t IA32_LBR_1509_FROM_IP = 0x00001509;
    ...
    constexpr uint32_t IA32_LBR_150A_FROM_IP = 0x0000150A;
    ...
    constexpr uint32_t IA32_LBR_150B_FROM_IP = 0x0000150B;
    ...
    constexpr uint32_t IA32_LBR_150C_FROM_IP = 0x0000150C;
    ...
    constexpr uint32_t IA32_LBR_150D_FROM_IP = 0x0000150D;
    ...
    constexpr uint32_t IA32_LBR_150E_FROM_IP = 0x0000150E;
    ...
    constexpr uint32_t IA32_LBR_150F_FROM_IP = 0x0000150F;
    ...
    constexpr uint32_t IA32_LBR_1510_FROM_IP = 0x00001510;
    ...
    constexpr uint32_t IA32_LBR_1511_FROM_IP = 0x00001511;
    ...
    constexpr uint32_t IA32_LBR_1512_FROM_IP = 0x00001512;
    ...
    constexpr uint32_t IA32_LBR_1513_FROM_IP = 0x00001513;
    ...
    constexpr uint32_t IA32_LBR_1514_FROM_IP = 0x00001514;
    ...
    constexpr uint32_t IA32_LBR_1515_FROM_IP = 0x00001515;
    ...
    constexpr uint32_t IA32_LBR_1516_FROM_IP = 0x00001516;
    ...
    constexpr uint32_t IA32_LBR_1517_FROM_IP = 0x00001517;
    ...
    constexpr uint32_t IA32_LBR_1518_FROM_IP = 0x00001518;
    ...
    constexpr uint32_t IA32_LBR_1519_FROM_IP = 0x00001519;
    ...
    constexpr uint32_t IA32_LBR_151A_FROM_IP = 0x0000151A;
    ...
    constexpr uint32_t IA32_LBR_151B_FROM_IP = 0x0000151B;
    ...
    constexpr uint32_t IA32_LBR_151C_FROM_IP = 0x0000151C;
    ...
    constexpr uint32_t IA32_LBR_151D_FROM_IP = 0x0000151D;
    ...
    constexpr uint32_t IA32_LBR_151E_FROM_IP = 0x0000151E;
    ...
    constexpr uint32_t IA32_LBR_151F_FROM_IP = 0x0000151F;
    ...
    constexpr uint32_t IA32_LBR_1600_TO_IP = 0x00001600;
    ...
    constexpr uint32_t IA32_LBR_1601_TO_IP = 0x00001601;
    ...
    constexpr uint32_t IA32_LBR_1602_TO_IP = 0x00001602;
    ...
    constexpr uint32_t IA32_LBR_1603_TO_IP = 0x00001603;
    ...
    constexpr uint32_t IA32_LBR_1604_TO_IP = 0x00001604;
    ...
    constexpr uint32_t IA32_LBR_1605_TO_IP = 0x00001605;
    ...
    constexpr uint32_t IA32_LBR_1606_TO_IP = 0x00001606;
    ...
    constexpr uint32_t IA32_LBR_1607_TO_IP = 0x00001607;
    ...
    constexpr uint32_t IA32_LBR_1608_TO_IP = 0x00001608;
    ...
    constexpr uint32_t IA32_LBR_1609_TO_IP = 0x00001609;
    ...
    constexpr uint32_t IA32_LBR_160A_TO_IP = 0x0000160A;
    ...
    constexpr uint32_t IA32_LBR_160B_TO_IP = 0x0000160B;
    ...
    constexpr uint32_t IA32_LBR_160C_TO_IP = 0x0000160C;
    ...
    constexpr uint32_t IA32_LBR_160D_TO_IP = 0x0000160D;
    ...
    constexpr uint32_t IA32_LBR_160E_TO_IP = 0x0000160E;
    ...
    constexpr uint32_t IA32_LBR_160F_TO_IP = 0x0000160F;
    ...
    constexpr uint32_t IA32_LBR_1610_TO_IP = 0x00001610;
    ...
    constexpr uint32_t IA32_LBR_1611_TO_IP = 0x00001611;
    ...
    constexpr uint32_t IA32_LBR_1612_TO_IP = 0x00001612;
    ...
    constexpr uint32_t IA32_LBR_1613_TO_IP = 0x00001613;
    ...
    constexpr uint32_t IA32_LBR_1614_TO_IP = 0x00001614;
    ...
    constexpr uint32_t IA32_LBR_1615_TO_IP = 0x00001615;
    ...
    constexpr uint32_t IA32_LBR_1616_TO_IP = 0x00001616;
    ...
    constexpr uint32_t IA32_LBR_1617_TO_IP = 0x00001617;
    ...
    constexpr uint32_t IA32_LBR_1618_TO_IP = 0x00001618;
    ...
    constexpr uint32_t IA32_LBR_1619_TO_IP = 0x00001619;
    ...
    constexpr uint32_t IA32_LBR_161A_TO_IP = 0x0000161A;
    ...
    constexpr uint32_t IA32_LBR_161B_TO_IP = 0x0000161B;
    ...
    constexpr uint32_t IA32_LBR_161C_TO_IP = 0x0000161C;
    ...
    constexpr uint32_t IA32_LBR_161D_TO_IP = 0x0000161D;
    ...
    constexpr uint32_t IA32_LBR_161E_TO_IP = 0x0000161E;
    ...
    constexpr uint32_t IA32_LBR_161F_TO_IP = 0x0000161F;

    // Hardware Feedback Interface Pointer
    constexpr uint32_t IA32_HW_FEEDBACK_PTR = 0x000017D0;

    // Hardware Feedback Interface Configuration If CPUID.06H:EAX.[19] = 1
    constexpr uint32_t IA32_HW_FEEDBACK_CONFIG = 0x000017D1;

    // Thread Feedback Characteristics (R/O)
    constexpr uint32_t IA32_THREAD_FEEDBACK_CHAR = 0x000017D2;

    // Hardware Feedback Thread Configuration (R/W)
    constexpr uint32_t IA32_HW_FEEDBACK_THREAD_CONFI = 0x000017D4;

    // History Reset Enable (R/W)
    constexpr uint32_t IA32_HRESET_ENABLE = 0x000017DA;
    ...
    // Auxiliary TSC (R/W)
    constexpr uint32_t IA32_TSC_AUX = 0xC0000103;
    ...
    static_assert(sizeof(msr_t<IA32_FEATURE_CONTROL>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRRCAP>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_SYSENTER_CS>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_SYSENTER_EIP>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_SYSENTER_ESP>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MISC_ENABLE>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_SMRR_PHYSBASE>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_SMRR_PHYSMASK>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSBASE0>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSMASK0>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSBASE1>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSMASK1>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSBASE2>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSMASK2>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSBASE3>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSMASK3>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSBASE4>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSMASK4>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSBASE5>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSMASK5>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSBASE6>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSMASK6>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSBASE7>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSMASK7>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSBASE8>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSMASK8>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSBASE9>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_PHYSMASK9>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_FIX64K_00000>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_FIX16K_80000>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_FIX16K_A0000>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_FIX4K_C0000>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_FIX4K_C8000>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_FIX4K_D0000>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_FIX4K_D8000>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_FIX4K_E0000>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_FIX4K_E8000>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_FIX4K_F0000>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_FIX4K_F8000>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_MTRR_DEF_TYPE>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_BASIC>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_PINBASED_CTLS>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_PROCBASED_CTLS>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_EXIT_CTLS>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_ENTRY_CTLS>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_MISC>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_CR0_FIXED0>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_CR0_FIXED1>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_CR4_FIXED0>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_CR4_FIXED1>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_VMCS_ENUM>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_PROCBASED_CTLS2>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_EPT_VPID_CAP>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_TRUE_PINBASED_CTLS>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_TRUE_PROCBASED_CTLS>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_TRUE_EXIT_CTLS>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_TRUE_ENTRY_CTLS>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_VMFUNC>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_PROCBASED_CTLS3>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_VMX_EXIT_CTLS2>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_EFER>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_STAR>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_LSTAR>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_FMASK>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_FS_BASE>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_GS_BASE>) == sizeof(uint64_t));
    ...
    static_assert(sizeof(msr_t<IA32_KERNEL_GS_BASE>) == sizeof(uint64_t));
    static_assert(sizeof(msr_t<IA32_KERNEL_GS_BASE>::storage) == sizeof(msr_t<IA32_KERNEL_GS_BASE>::semantics));

    [[nodiscard]]
    inline uint64_t read_msr(uint32_t address) noexcept {
        return uint64_t{ __readmsr(address) };
    }

    inline void write_msr(uint32_t msr_address, uint64_t msr_value) noexcept {
        return __writemsr(msr_address, msr_value);
    }

    template<uint32_t MsrAddress>
    [[nodiscard]]
