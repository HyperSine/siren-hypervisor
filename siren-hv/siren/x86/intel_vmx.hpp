...
namespace siren::x86 {
    ...
    struct alignas(4_Kiuz) vmxon_region_t {
        uint32_t revision : 31;
        uint32_t reserved : 1;
        uint8_t used_by_cpu[1];     // ANYSIZE_ARRAY
    };

    static_assert(alignof(vmxon_region_t) == 4_Kiuz);
    ...
    struct alignas(4_Kiuz) vmcs_region_t {
        uint32_t revision : 31;
    ...
    static_assert(alignof(vmcs_region_t) == 4_Kiuz);
...
#undef SIREN_VMCSF_SIZE_GUARD
    ...
    static_assert(alignof(vmx_msr_bitmap_t) == 4_Kiuz);
