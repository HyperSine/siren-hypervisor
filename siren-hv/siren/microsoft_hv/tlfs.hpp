...
namespace siren::microsoft_hv {
    ...
    struct alignas(4_Kiuz) vp_assist_page_t {
        //
    ...
    static_assert(sizeof(vp_assist_page_t) == 4_Kiuz);
    ...
    static_assert(alignof(vp_assist_page_t) == 4_Kiuz);

    struct alignas(4_Kiuz) vmx_enlightened_vmcs_t {
    ...
    static_assert(sizeof(vmx_enlightened_vmcs_t) <= 4_Kiuz);
    static_assert(alignof(vmx_enlightened_vmcs_t) == 4_Kiuz);

    struct alignas(4_Kiuz) partition_assist_page_t {
        uint32_t tlb_lock_count;
    };

    static_assert(sizeof(partition_assist_page_t) <= 4_Kiuz);
    static_assert(alignof(partition_assist_page_t) == 4_Kiuz);
}
